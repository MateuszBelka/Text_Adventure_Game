...
public class DoListen {
    ...
    public static void doListen(){
        //todo: print:  CollectionOfAllClasses.getPlayer().getCurrentLocation().getTextForListening();
    }

    public static void doListenTo(Item item){
        //todo: print: item.getTextForListening();

    }

    public static void doListenTo(NPC npc){
        //todo: print: npc.getTextForListening();
    }
