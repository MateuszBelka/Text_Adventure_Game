...
| F12 | Hunger level | A numerical measurement that determines whether a character is starving or not. High hunger level leads to health points reduction, while health point reduction may lead to death. The hungrier the character, the more hunger points will be gained. A player has to feed a character and pay attention to the hunger level so that the character will be able to function. Current hunger level against the maximum hunger level shall always be visible to a player. | Hunger is an additional challenge for a player that will make a story more interesting and game experience more enjoyable. |
